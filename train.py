...
parser.add_argument('--server_model_layers', type=str, default='1536')
parser.add_argument('--client_model_layers', type=str, default='1536')
...
for round in range(config['num_round']):
    ...
    # test_recall, test_precision, test_ndcg = engine.fed_evaluate(test_data, test_item_img_features, test_item_text_features, test_item_ids_map)
    ...
    # vali_recall, vali_precision, vali_ndcg = engine.fed_evaluate(vali_data, vali_item_img_features, vali_item_text_features, vali_item_ids_map)
    # logging.info('Recall@{} = {:.6f}, Recall@{} = {:.6f}, Recall@{} = {:.6f}'.format(
